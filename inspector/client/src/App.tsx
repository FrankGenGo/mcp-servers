...
import { DEFAULT_MCP_SERVER_URL } from "./lib/config";
...
const App = () => {
  ...
  const [sseUrl, setSseUrl] = useState<string>(() => {
    return localStorage.getItem("lastSseUrl") || DEFAULT_MCP_SERVER_URL;
  });
  const [transportType, setTransportType] = useState<"stdio" | "sse">(() => {
    return (
      (localStorage.getItem("lastTransportType") as "stdio" | "sse") || "sse"
    );
  });
